...
<head>
	...
	<script type="text/javascript">
      ...
      function stockdrawChart(chartId) {
          var data = google.visualization.arrayToDataTable([
            ['基金', '現在總價值'],
            <c:forEach var="stock" items="${ stockMap }">
				...
				<spform:form   class="pure-form" method="POST"
					...
					<fieldset>
						...
						<button type="button" class="pure-button pure-button-primary"
							${ _method=='PUT'?'':'disabled' } onclick="updateFundstock(${ sid })">修改</button>
							<button type="button" class="pure-button pure-button-primary"
							${ _method=='PUT'?'':'disabled' } onclick="deleteFundstock(${ sid })">刪除</button>	 
			...
			<td valign="top">
				...
				<form class="pure-form">
					<fieldset>
						<legend>
							基金圖 |
							<a href="#" onclick="stockdrawChart(1)">bar</a> |
							<a href="#" onclick="stockdrawChart(2)">pie</a> |
							<a href="#" onclick="stockdrawChart(3)">column</a> |
							<a href="#" onclick="stockdrawChart(4)">line</a>
						</legend>
