...
public class JsonDB {//Json 資料庫
	...
	private Gson gson; 
	//Json file  資料庫存放地
	private static final Path PATH=Paths.get("src/main/java/com/study/spring3/homework2/person.json");
...
//			   =p.getBirth().toInstant().atZone(ZoneId.systemDefault())
//			      .toLocalDate();
//			
//		    int age =todayLocalDate.getYear()-birthdayDate.getYear();
//			p.setAge(age);
//		
//		
//		}
