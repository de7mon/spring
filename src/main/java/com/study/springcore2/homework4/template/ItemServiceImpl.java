package com.study.springcore2.homework4.template;
...
import com.study.springcore2.homework4.entity.Invoice;
import com.study.springcore2.homework4.entity.Item;
import com.study.springcore2.homework4.entity.ItemProduct;
   ...
   //每一張發票有幾件商品?
	...
	public void InvoiceProductCount() {
		String sql="select  I.invid , IP.text,  I.amount  \r\n"
				...
				;
		List<Map<String , Object>> invpro=jdbcTemplate.queryForList(sql);
		System.out.println(invpro.getClass().getSimpleName());
		System.out.println(jdbcTemplate.queryForList(sql));
	}
